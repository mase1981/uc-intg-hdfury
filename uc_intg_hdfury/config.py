# path: C:\Documents\GitHub\uc-intg-hdfury\uc_intg_hdfury\config.py
import json
import logging
import os
...
class HDFuryDeviceConfig:
    identifier: str; name: str; host: str; port: int

class Devices:
    def __init__(self, config_dir: str, on_add: Callable | None, on_remove: Callable | None):
        self.config_dir = config_dir
        self.config_file_path = os.path.join(config_dir, "config.json") # Using config.json
        self._on_add = on_add
